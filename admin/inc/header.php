...
<head>
    ...
    <title><?php echo basename( $_SERVER['PHP_SELF'], '.php' ); ?> | Project using OOP</title>
    <!-- Favicon icon -->
...
?>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="sliders.php" aria-expanded="false">
                            <i class="mdi mdi-view-carousel">
                            </i><span class="hide-menu">Sliders</span>
                            </a>
                        </li>
